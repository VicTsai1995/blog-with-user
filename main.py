...
def register():
    ...
    if form.validate_on_submit():
        ...
        password_after_hash = generate_password_hash(password=form.password.data, salt_length=8, method='pbkdf2:sha256')
        new_user = User(
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            flash("This mail does not exist. Please try again.")
